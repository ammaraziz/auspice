...
export const LOAD_MULTIPLOT_COLLECTIONS = "LOAD_MULTIPLOT_COLLECTIONS";
export const CHANGE_MULTIPLOT_COLLECTION = "CHANGE_MULTIPLOT_COLLECTION";
export const CHANGE_MULTIPLOT_GROUP_BY = "CHANGE_MULTIPLOT_GROUP_BY";
export const APPLY_MULTIPLOT_FILTER = "APPLY_MULTIPLOT_FILTER";
export const TOGGLE_MULTIPLOT_OVERALL_MEAN = "TOGGLE_MULTIPLOT_OVERALL_MEAN";
export const TOGGLE_MULTIPLOT_THRESHOLD = "TOGGLE_MULTIPLOT_THRESHOLD";
